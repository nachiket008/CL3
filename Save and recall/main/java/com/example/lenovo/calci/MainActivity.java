...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button button0, button1, button2,button3,button4,button5,button6,button7,
            ...
            buttonAdd, buttonPercentage, buttonEqual, buttonDecimal, closeParenthesis, openParenthesis, buttonAns,
    ...
    private Button buttonSin, buttonLn,buttonCos, buttonLog, buttonTan, buttonSquareRoot,  buttonXSquare, buttonYPowerX,
            buttonfactorial,buttonPi,buttonCubeRoot,buttonCube;
...
//        buttonExp.setOnClickListener(this);
        ...
        H.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        buttonAns.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                lastResultObtain="";
                return true;
    ...
    public void onClick(View view) {
        ...
        else if(data.equals("="))
        {
            ...
            history.add(str);
          //  Toast.makeText(this, history.get(0), Toast.LENGTH_SHORT).show();
            outputResult.setText(removeTrailingZero(resultObject));
        }
        else if(data.equals("Ans"))
        {
            lastResultObtain = resultObject;
           // inputToBeParsed = lastResultObtain;
            outputResult.setText(lastResultObtain);
            inputToBeParsed += lastResultObtain;
        }
